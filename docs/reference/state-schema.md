...
The `skipped` state occurs when a holdout file was generated by `pipeline-build-prompt` but the `SubagentStop` hook did not wire the `holdout_review_file` field. The pipeline records this gracefully rather than blocking.
